  ...
  return (
   <section className='common-padding h-full bg-zinc overflow-hidden relative'>
      <div className=' screen-max-width'>
           ...
           <div className='flex-col justify-center itemscenter overflow-hidden'>
          <div className='mt-32 mb-24 pl-24'>
           ...
           <div className='flex-center flex-col sm:px-10 '>
               <div className='relative h-[50vh] w-full flex items-center'>
                  <video playsInline id='exploreVideo' className='w-full pb-5 h-full object-cover object-center' preload='none' muted autoPlay
                  ref={videoRef}>
                    ...
                    <div className='feature-text-container'>
                       ...
                       <div className='flex-1 flex-center'>
                           <p id='g_text' className='feature-text g_text'>
                              ...
                              You'll notice the difference the moment you pick me up.
                           </p>
                       </div>
                    </div>
